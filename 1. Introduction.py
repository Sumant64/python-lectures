...
"""
o Python is a popular programming language. It was created by Guido van Rossum, and released in 1991.
Why Python?
...
o Python runs on an interpreter system, meaning that code can be executed as soon as it is written. 
